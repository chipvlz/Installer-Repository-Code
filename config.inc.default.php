...
//define('ZIP_CMDLINE_PATH', '/usr/bin/unzip');	// Only define/uncomment this if your unzip command line tool is not in the standard location (or regenerate.php throws an error).
